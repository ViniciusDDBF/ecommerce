  ...
  return (
    <Overlay onClick={closeReviewModal} isOpen={selectedReview !== null}>
      ...
      >
        ...
        <div className="bg-charcoal-800 border-charcoal-600 pointer-events-auto flex min-h-screen w-full flex-col md:fixed md:top-0 md:right-0 md:h-[100vh] md:min-h-0 md:w-96 md:overflow-hidden md:border-l">
          {/* ---------- Header ---------- */}
          ...
          <div className="flex-1 space-y-4 p-4 md:overflow-y-auto">
            ...
            <p className="text-charcoal-300 text-sm leading-relaxed break-words">
